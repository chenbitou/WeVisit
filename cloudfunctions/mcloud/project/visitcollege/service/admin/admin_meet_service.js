...
class AdminMeetService extends BaseProjectAdminService {
	...
	async vouchMeetSetup(id, vouch) {
		this.AppError('[校园参观]该功能暂不开放，如有需要请加作者微信：cclinux0730');
	}
	...
	async getJoinDetail(id) {
		return await JoinModel.getOne(id);
	}
	...
	async getJoinList({
		...
		let fields = 'JOIN_IS_CHECKIN,JOIN_CODE,JOIN_ID,JOIN_REASON,JOIN_USER_ID,JOIN_MEET_ID,JOIN_MEET_TITLE,JOIN_MEET_DAY,JOIN_MEET_TIME_START,JOIN_MEET_TIME_END,JOIN_NAME_LIST,JOIN_MEET_TIME_MARK,JOIN_CNT,JOIN_STATUS,JOIN_EDIT_TIME';
